            ...
            switch(lua_type(state,stack_index)){
                ...
                case LUA_TSTRING:{
                    ...
                    if([original isKindOfClass:[NSData class]]) {
                        ...
                        result=[[[tmpData alloc] initWithData:tmpData encoding:NSUTF8StringEncoding] autorelease];
                    }
#else
                    result=[[[NSString alloc] initWithData:tmpData encoding:NSUTF8StringEncoding] autorelease];
#endif
                    break;
                }
